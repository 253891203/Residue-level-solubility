...
def main():
    parser = argparse.ArgumentParser(
        description="Run the fixed ESM2 MLP-N baseline dimensions without hyperparameter search."
    )
    ...
    paths = {
        split: args.embedding_dir / f"esm2-500t-{split}_streamv3_maxlen500.h5"
