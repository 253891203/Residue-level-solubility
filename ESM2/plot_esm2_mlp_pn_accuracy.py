...
def main():
    parser = argparse.ArgumentParser(
        description="Plot the ESM2 P/N accuracy series used in the paper figure."
    )
    parser.add_argument(
        "--results",
        type=Path,
        default=Path("outputs/results/esm2_representation_results.csv"),
    )
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("outputs/figures/esm2_mlp_pn_accuracy.png"),
    )
    ...
    axis.set_title("ESM2-650M MLP P/N-representation accuracy")
